...
/* MEM_Segment6x55 */
struct ti_bios_rov_MEM_MEM_Segment6x55 {
    xdc_Ptr base;
    xdc_UInt len;
    xdc_Int space;
};
...
/* MEM_Segment28x55L */
struct ti_bios_rov_MEM_MEM_Segment28x55L {
    xdc_Ptr base;
    xdc_ULong len;
    xdc_Int space;
};
...
/* MEM_Header6x55 */
struct ti_bios_rov_MEM_MEM_Header6x55 {
    ti_bios_rov_MEM_MEM_Header6x55* next;
    xdc_UInt size;
};

/* MEM_Header28x55L */
struct ti_bios_rov_MEM_MEM_Header28x55L {
    ti_bios_rov_MEM_MEM_Header28x55L* next;
    xdc_ULong size;
};
...
/* Module__loggerFxn0 */
typedef xdc_runtime_Types_LoggerFxn0 CT__ti_bios_rov_MEM_Module__loggerFxn0;
__extern __FAR__ const CT__ti_bios_rov_MEM_Module__loggerFxn0 ti_bios_rov_MEM_Module__loggerFxn0__C;

/* Module__loggerFxn1 */
typedef xdc_runtime_Types_LoggerFxn1 CT__ti_bios_rov_MEM_Module__loggerFxn1;
__extern __FAR__ const CT__ti_bios_rov_MEM_Module__loggerFxn1 ti_bios_rov_MEM_Module__loggerFxn1__C;

/* Module__loggerFxn2 */
typedef xdc_runtime_Types_LoggerFxn2 CT__ti_bios_rov_MEM_Module__loggerFxn2;
__extern __FAR__ const CT__ti_bios_rov_MEM_Module__loggerFxn2 ti_bios_rov_MEM_Module__loggerFxn2__C;
...
#ifndef ti_bios_rov_MEM__localnames__done
#define ti_bios_rov_MEM__localnames__done

/* module prefix */
#define MEM_MEM_Segment6x55 ti_bios_rov_MEM_MEM_Segment6x55
#define MEM_MEM_Segment28x55L ti_bios_rov_MEM_MEM_Segment28x55L
#define MEM_MEM_Header6x55 ti_bios_rov_MEM_MEM_Header6x55
#define MEM_MEM_Header28x55L ti_bios_rov_MEM_MEM_Header28x55L
...
#endif /* ti_bios_rov_MEM__localnames__done */
#endif
