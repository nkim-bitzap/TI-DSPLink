...
/* LoggerFxn4 */
typedef xdc_Void (*xdc_runtime_Types_LoggerFxn4)(xdc_Ptr, xdc_runtime_Types_EventId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);

/* LoggerFxn8 */
typedef xdc_Void (*xdc_runtime_Types_LoggerFxn8)(xdc_Ptr, xdc_runtime_Types_EventId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
...
/* ModHdr */
struct xdc_runtime_Types_ModHdr {
    xdc_runtime_Types_Link link;
    xdc_UChar* instArrBeg;
    xdc_UChar* instArrEnd;
    xdc_SizeT instSize;
    xdc_UChar* curInst;
    xdc_Bits16 diagsMask;
};

/* ModHdrS */
struct xdc_runtime_Types_ModHdrS {
    xdc_Bits16 diagsMask;
};
...
#define Types_ModHdr xdc_runtime_Types_ModHdr
#define Types_ModHdrS xdc_runtime_Types_ModHdrS
