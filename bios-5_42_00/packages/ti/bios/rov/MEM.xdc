...
module MEM {
    ...
    /*!
     *  ======== MEM_Segment6x55 ========
     *  BIOS 5 target structure representing a MEM_Segment on 6x and 55 small 
     *  devices.
     *
     ...
     *    6x, 55        -   unsigned int
     */ 
    struct MEM_Header6x55 {
        MEM_Header6x55    *next;   /* form a free memory link list */
     ...
     *    6x, 55        -   unsigned int
     */ 
    struct MEM_Header28x55L {
        MEM_Header28x55L    *next;   /* form a free memory link list */
