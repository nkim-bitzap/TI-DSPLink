...
library_t LIBRARIES[] = {
    ...
    { "rts6600_elf_mt_eh.lib", { "EABI_TDEH","EXCEPTIONS","MT","C6600" } },
    { "rts64plus_elf_mt_eh.lib", { "C64P","EABI_TDEH","EXCEPTIONS","MT" } },
    { "rts6600e_elf_mt_eh.lib", { "EXCEPTIONS","MT","BIG_ENDIAN","EABI_TDEH","C6600" } },
    { "rts6740_elf_eh.lib", { "C6740","EXCEPTIONS","EABI_TDEH" } },
    { "rts6600e_elf_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI_TDEH","C6600" } },
    { "rts64pluse_elf_mt_eh.lib", { "EABI_TDEH","MT","EXCEPTIONS","BIG_ENDIAN","C64P" } },
    { "rts6600e_elf_mt.lib", { "BIG_ENDIAN","MT","C6600" } },
    { "rts64plus_elf_mt.lib", { "C64P","MT" } },
    { "rts6740e_elf_mt_eh.lib", { "C6740","EABI_TDEH","BIG_ENDIAN","MT","EXCEPTIONS" } },
    { "rts6600_elf.lib", { "C6600" } },
    { "rts6740_elf_mt.lib", { "MT","C6740" } },
    { "rts64pluse_elf.lib", { "BIG_ENDIAN","C64P" } },
    { "rts64plus_elf_eh.lib", { "C64P","EABI_TDEH","EXCEPTIONS" } },
    { "rts6600_elf_mt.lib", { "MT","C6600" } },
    { "rts6740e_elf.lib", { "BIG_ENDIAN","C6740" } },
    { "rts6740_elf_mt_eh.lib", { "C6740","EXCEPTIONS","MT","EABI_TDEH" } },
    { "rts6740e_elf_eh.lib", { "EXCEPTIONS","BIG_ENDIAN","EABI_TDEH","C6740" } },
    { "rts64pluse_elf_mt.lib", { "C64P","MT","BIG_ENDIAN" } },
    { "rts6740e_elf_mt.lib", { "BIG_ENDIAN","MT","C6740" } },
    { "rts6740_elf.lib", { "C6740" } },
    { "rts6600e_elf.lib", { "C6600","BIG_ENDIAN" } },
    { "rts6600_elf_eh.lib", { "EABI_TDEH","EXCEPTIONS","C6600" } },
};
