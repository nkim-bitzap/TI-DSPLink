...
/*!
 *  ======== ti.platforms.qtPrimus ========
 *  Platform package for the Primus Quickturn.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the primus quickturn platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.qtPrimus.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.qtPrimus [1,0,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.qtPrimus; 1, 0, 0, 0,99; 12-9-2009 17:31:08; /db/ztree/library/trees/platform/platform-k27x/src/
 */
