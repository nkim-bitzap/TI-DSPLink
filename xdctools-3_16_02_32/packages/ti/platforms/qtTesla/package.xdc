...
/*!
 *  ======== ti.platforms.qtTesla ========
 *  Platform package for the Tesla Quickturn.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the Tesla quickturn platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.qtTesla.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.qtTesla [1,0,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.qtTesla; 1, 0, 0, 0,75; 12-9-2009 17:31:09; /db/ztree/library/trees/platform/platform-k27x/src/
 */
