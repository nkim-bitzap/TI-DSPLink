 ...
 *
 *  Idicate an error from this module but allow additional errors
 *  to be logged.
 */
...
xdc.global.$externFxn = function( sym ) {
    return xdc.global.$$Extern(sym, null, true, true, null);
};
xdc.global.$externPtr = function( sym ) {
    return xdc.global.$$Extern(sym, null, false, true, null);
};
...
/*
 *  @(#) xdc; 1, 1, 1,238; 12-18-2009 12:26:15; /db/ztree/library/trees/xdc/xdc-u16x/src/packages/
 */
