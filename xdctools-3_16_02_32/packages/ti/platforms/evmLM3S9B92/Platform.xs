...
function module$meta$init()
{
    ...
    Boot.sysClockDivEnable = true;
    Boot.sysClockDiv = Boot.SYSDIV_4;   /* 50 MHz */
    Boot.pwmClockDivEnable = true;
...
/*
 *  @(#) ti.platforms.evmLM3S9B92; 1, 0, 0,28; 12-9-2009 17:22:25; /db/ztree/library/trees/platform/platform-k27x/src/
 */
