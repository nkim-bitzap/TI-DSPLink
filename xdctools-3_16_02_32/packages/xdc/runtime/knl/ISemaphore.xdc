 ...
 *
 *  reset() sets the semaphore count to a given value. There should be no
 *  threads waiting on the semaphore when reset() is called.
 *
 */
...
/*
 *  @(#) xdc.runtime.knl; 1, 0, 0,45; 12-18-2009 12:27:13; /db/ztree/library/trees/xdc/xdc-u16x/src/packages/
 */
