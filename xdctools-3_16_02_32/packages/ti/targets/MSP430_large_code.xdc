...
/*!
 *  ======== MSP430_large_code.xdc ========
 *  TI MSP430 large model, little endian target
 */

metaonly module MSP430_large_code inherits ti.targets.ITarget {
    override readonly config string name             = "MSP430_large_code"; 
     ...
     */
    config string linkLib = "rts430x.lib";
