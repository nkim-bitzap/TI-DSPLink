...
function instance$meta$init(name, args)
{
    ...
    if (args != null) {
        ...
        this.$module.$logError("Parameters deviceName, catalogName and " +
            "clockRate must be specified for 'ti.platforms.generic' platform.",
            this, args);
    }
}
...
/*
 *  @(#) ti.platforms.generic; 1, 0, 0, 1,265; 12-9-2009 17:21:23; /db/ztree/library/trees/platform/platform-k27x/src/
 */
