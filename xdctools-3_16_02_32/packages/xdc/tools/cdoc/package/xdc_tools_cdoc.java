...
public class xdc_tools_cdoc
{
    ...
    void Example$$CONSTS()
    {
        ...
        om.bind("xdc.tools.cdoc.Example.aFunction", new Extern("xdc_tools_cdoc_Example_aFunction__E", "xdc_Void(*)(xdc_Int)", true, false, "xdc.tools.cdoc.Example.aFunction"));
    }
    ...
    void Main$$TYPES()
    {
        ...
        po.init("xdc.tools.cdoc.Main.Module", om.findStrict("xdc.tools.ICmd.Module", "xdc.tools.cdoc"));
                ...
                po.addFld("usage", new Proto.Arr($$T_Str, false), Global.newArray(new Object[]{"[-od:dir] [-title text] [--start package] [--indexonly] [-h] [-n] [-b] [-s] [-P pkg-dir...|-Pr repo-dir...|-A]"}), "wh");
