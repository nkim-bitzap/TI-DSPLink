...
/*!
 *  ======== MSP430_large_data.xdc ========
 *  TI MSP430 large model, little endian target
 */

metaonly module MSP430_large_data inherits ti.targets.ITarget {
    override readonly config string name             = "MSP430_large_data"; 
    override readonly config string suffix           = "430XL";
     ...
     */
    config string linkLib = "rts430xl.lib";
