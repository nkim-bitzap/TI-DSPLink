...
/* TI ADDITIONS */
   ...
   #endif
 #define _D2    2       /* big-endian */
 #define _D3    3       /* big-endian */

 #define _DBIAS	0x7e    /* same as _FBIAS */
 #define _DOFF	7       /* same as _FOFF  */

 #define _FBIAS	0x7e    /* for IEEE       */
 #define _FOFF	7       /* for IEEE       */
 #define _FRND	1       /* for IEEE       */

 #define _DLONG	0       /* 0 for long double same as double */
 #define _LBIAS	0x7e    /* same as _FBIAS                   */
 #define _LOFF	7       /* same as _FOFF                    */
