/*---------------------------------------------------------------------------
 * This is mklib version 4.4.1 for C5500 compiler  
...
/*--------------------------------------------------------------------------- 
 * This source code is specific to compiler RTS library version 4.4.1.  
...
const char *isa = "C5500";
const char *version = "4.4.1";
int         buildmodel = 2011;
const char *c_dir_name = "C55X_C_DIR";
...
library_t LIBRARIES[] = {
    { "rts55px.lib", { "C55P","LMM" } },
    { "rts552.lib", { "PHASE2" } },
    { "rts55x_eh.lib", { "FULL_PORTABLE_EH","LMM","EXCEPTIONS","CORE123_SAFE" } },
    { "rts55_eh.lib", { "FULL_PORTABLE_EH","EXCEPTIONS","CORE123_SAFE" } },
    { "rts55phb.lib", { "C55P","HMM","BYTE_MODE" } },
    { "rts55.lib", { "CORE123_SAFE" } },
    { "rts55p.lib", { "C55P" } },
    { "rts55phb_eh.lib", { "FULL_PORTABLE_EH","C55P","HMM","BYTE_MODE","EXCEPTIONS" } },
    { "rts55px_eh.lib", { "FULL_PORTABLE_EH","C55P","LMM","EXCEPTIONS" } },
    { "rts55ph_eh.lib", { "FULL_PORTABLE_EH","C55P","HMM","EXCEPTIONS" } },
    { "rts55pxb_eh.lib", { "FULL_PORTABLE_EH","C55P","LMM","BYTE_MODE","EXCEPTIONS" } },
    { "rts55h.lib", { "HMM","CORE3" } },
    { "rts55h_eh.lib", { "FULL_PORTABLE_EH","HMM","EXCEPTIONS","CORE3" } },
    { "rts552_eh.lib", { "FULL_PORTABLE_EH","EXCEPTIONS","PHASE2" } },
    { "rts55x.lib", { "LMM","CORE123_SAFE" } },
    { "rts55ph.lib", { "C55P","HMM" } },
    { "rts55p_eh.lib", { "FULL_PORTABLE_EH","C55P","EXCEPTIONS" } },
    { "rts55pxb.lib", { "C55P","LMM","BYTE_MODE" } },
};
