...
struct xdc_runtime_LoggerSys_Fxns__ {
    ...
    xdc_Void (*write4)(xdc_runtime_LoggerSys_Handle, xdc_runtime_Types_Event, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
    xdc_Void (*write8)(xdc_runtime_LoggerSys_Handle, xdc_runtime_Types_Event, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
...
__extern xdc_Void xdc_runtime_LoggerSys_write4__E( xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Types_Event evt, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4 );
xdc__CODESECT(xdc_runtime_LoggerSys_write4__F, "xdc_runtime_LoggerSys_write4")
__extern xdc_Void xdc_runtime_LoggerSys_write4__F( xdc_runtime_LoggerSys_Object* __inst, xdc_runtime_Types_Event evt, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4 );
__extern xdc_Void xdc_runtime_LoggerSys_write4__R( xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Types_Event evt, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4 );
...
__extern xdc_Void xdc_runtime_LoggerSys_write8__E( xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Types_Event evt, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8 );
xdc__CODESECT(xdc_runtime_LoggerSys_write8__F, "xdc_runtime_LoggerSys_write8")
__extern xdc_Void xdc_runtime_LoggerSys_write8__F( xdc_runtime_LoggerSys_Object* __inst, xdc_runtime_Types_Event evt, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8 );
__extern xdc_Void xdc_runtime_LoggerSys_write8__R( xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Types_Event evt, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8 );
...
/* write4_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerSys_write4_FxnT)(void*, xdc_runtime_Types_Event, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
...
/* write8_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerSys_write8_FxnT)(void*, xdc_runtime_Types_Event, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
...
#endif
/*
 *  @(#) xdc.runtime; 2, 0, 0, 0,236; 12-18-2009 12:27:14; /db/ztree/library/trees/xdc/xdc-u16x/src/packages/
 */
