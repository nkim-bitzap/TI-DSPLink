...
function getExeContext(prog)
{
    ...
    if (cpu.memoryMap["LSARAM"] != undefined) {
        /* The change of the base addresses for LSARAM is 
         * a workaround for gdb2000. For an unknown reason, it won't run with
         * the original addresses. The error message is:
         * OTIS: Can't load COFF file on target.
         * .tmp11603:1: Error in sourced command file:
         * Cannot access memory at address 0x6200
         *
         * The address 0x6200 above is the address of .args section. 
         */
        cpu.memoryMap["LSARAM"].base = 0x4000;
    }
...
/*
 *  @(#) ti.platforms.sim2810; 1, 0, 0,266; 12-9-2009 17:31:14; /db/ztree/library/trees/platform/platform-k27x/src/
 */
