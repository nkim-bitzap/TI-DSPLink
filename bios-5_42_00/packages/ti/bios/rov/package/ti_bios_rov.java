...
public class ti_bios_rov
{
    ...
    void MEM$$OBJECTS()
    {
        ...
        pkgV.bind("MEM", vo);
        // decls 
        spo = (Proto.Obj)om.bind("ti.bios.rov.MEM$$MEM_Segment6x55", new Proto.Obj());
        om.bind("ti.bios.rov.MEM.MEM_Segment6x55", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.bios.rov.MEM$$MEM_Segment28x55L", new Proto.Obj());
        om.bind("ti.bios.rov.MEM.MEM_Segment28x55L", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.bios.rov.MEM$$MEM_Header6x55", new Proto.Obj());
        om.bind("ti.bios.rov.MEM.MEM_Header6x55", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.bios.rov.MEM$$MEM_Header28x55L", new Proto.Obj());
        om.bind("ti.bios.rov.MEM.MEM_Header28x55L", new Proto.Str(spo, false));
    ...
    void SWI$$OBJECTS()
    {
        ...
        spo = (Proto.Obj)om.bind("ti.bios.rov.SWI$$SWI_Obj_55", new Proto.Obj());
        om.bind("ti.bios.rov.SWI.SWI_Obj_55", new Proto.Str(spo, false));
    ...
    void OBJ$$OBJECTS()
    {
        ...
        pkgV.bind("OBJ", vo);
        // decls 
        spo = (Proto.Obj)om.bind("ti.bios.rov.OBJ$$OBJ_TSK_6x", new Proto.Obj());
        om.bind("ti.bios.rov.OBJ.OBJ_TSK_6x", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.bios.rov.OBJ$$OBJ_TSK_28x", new Proto.Obj());
        om.bind("ti.bios.rov.OBJ.OBJ_TSK_28x", new Proto.Str(spo, false));
        ...
        spo = (Proto.Obj)om.bind("ti.bios.rov.OBJ$$OBJ_SEM_28_55", new Proto.Obj());
        om.bind("ti.bios.rov.OBJ.OBJ_SEM_28_55", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.bios.rov.OBJ$$OBJ_MBX", new Proto.Obj());
        om.bind("ti.bios.rov.OBJ.OBJ_MBX", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.bios.rov.OBJ$$OBJ_MBX_28_55", new Proto.Obj());
        om.bind("ti.bios.rov.OBJ.OBJ_MBX_28_55", new Proto.Str(spo, false));
    ...
    void LOG$$OBJECTS()
    {
        ...
        spo = (Proto.Obj)om.bind("ti.bios.rov.LOG$$LOG_Event_28_55L", new Proto.Obj());
        om.bind("ti.bios.rov.LOG.LOG_Event_28_55L", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.bios.rov.LOG$$LOG_Event_55", new Proto.Obj());
        om.bind("ti.bios.rov.LOG.LOG_Event_55", new Proto.Str(spo, false));
    ...
    void ROV$$FUNCTIONS()
    {
        ...
        // fxn ROV.getTargetName
        fxn = (Proto.Fxn)om.bind("ti.bios.rov.ROV$$getTargetName", new Proto.Fxn(om.findStrict("ti.bios.rov.ROV.Module", "ti.bios.rov"), $$T_Str, 0, 0, false));
        // fxn ROV.getNickName
    ...
    void MEM$$SIZES()
    {
        ...
        so = (Proto.Str)om.findStrict("ti.bios.rov.MEM.MEM_Segment6x55", "ti.bios.rov");
        sizes.clear();
        sizes.add(Global.newArray("base", "UPtr"));
        sizes.add(Global.newArray("len", "UInt"));
        sizes.add(Global.newArray("space", "TInt"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.bios.rov.MEM.MEM_Segment6x55']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.bios.rov.MEM.MEM_Segment6x55']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.bios.rov.MEM.MEM_Segment6x55'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.bios.rov.MEM.MEM_Segment28x55L", "ti.bios.rov");
        sizes.clear();
        sizes.add(Global.newArray("base", "UPtr"));
        sizes.add(Global.newArray("len", "ULong"));
        sizes.add(Global.newArray("space", "TInt"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.bios.rov.MEM.MEM_Segment28x55L']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.bios.rov.MEM.MEM_Segment28x55L']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.bios.rov.MEM.MEM_Segment28x55L'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.bios.rov.MEM.MEM_Header6x55", "ti.bios.rov");
        sizes.clear();
        sizes.add(Global.newArray("next", "UPtr"));
        sizes.add(Global.newArray("size", "UInt"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.bios.rov.MEM.MEM_Header6x55']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.bios.rov.MEM.MEM_Header6x55']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.bios.rov.MEM.MEM_Header6x55'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.bios.rov.MEM.MEM_Header28x55L", "ti.bios.rov");
        sizes.clear();
        sizes.add(Global.newArray("next", "UPtr"));
        sizes.add(Global.newArray("size", "ULong"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.bios.rov.MEM.MEM_Header28x55L']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.bios.rov.MEM.MEM_Header28x55L']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.bios.rov.MEM.MEM_Header28x55L'], fld); }");
        so.bind("$offsetof", fxn);
    }
    ...
    void SWI$$SIZES()
    {
        ...
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.bios.rov.SWI.SWI_Obj_55", "ti.bios.rov");
        sizes.clear();
        sizes.add(Global.newArray("lock", "TInt"));
        sizes.add(Global.newArray("ready", "UPtr"));
        sizes.add(Global.newArray("mask", "UInt"));
        ...
        sizes.add(Global.newArray("mailbox", "UInt"));
        sizes.add(Global.newArray("fxn", "UFxn"));
        sizes.add(Global.newArray("arg1", "UPtr"));
        sizes.add(Global.newArray("arg0", "UPtr"));
        sizes.add(Global.newArray("stslock", "TInt"));
        sizes.add(Global.newArray("sts", "UPtr"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.bios.rov.SWI.SWI_Obj_55']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.bios.rov.SWI.SWI_Obj_55']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.bios.rov.SWI.SWI_Obj_55'], fld); }");
        so.bind("$offsetof", fxn);
    }
    ...
    void OBJ$$SIZES()
    {
        ...
        so = (Proto.Str)om.findStrict("ti.bios.rov.OBJ.OBJ_TSK_6x", "ti.bios.rov");
        sizes.clear();
        ...
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.bios.rov.OBJ.OBJ_TSK_6x']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.bios.rov.OBJ.OBJ_TSK_6x']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.bios.rov.OBJ.OBJ_TSK_6x'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.bios.rov.OBJ.OBJ_TSK_28x", "ti.bios.rov");
        sizes.clear();
        sizes.add(Global.newArray("link", "Sti.bios.rov.QUE;QUE_Elem"));
        sizes.add(Global.newArray("type", "UInt"));
        ...
        sizes.add(Global.newArray("obj", "Sti.bios.rov.TSK;TSK_Obj"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.bios.rov.OBJ.OBJ_TSK_28x']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.bios.rov.OBJ.OBJ_TSK_28x']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.bios.rov.OBJ.OBJ_TSK_28x'], fld); }");
        so.bind("$offsetof", fxn);
        ...
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.bios.rov.OBJ.OBJ_SEM_28_55", "ti.bios.rov");
        sizes.clear();
        sizes.add(Global.newArray("link", "Sti.bios.rov.QUE;QUE_Elem"));
        sizes.add(Global.newArray("type", "UInt"));
        sizes.add(Global.newArray("pad", "UInt"));
        sizes.add(Global.newArray("obj", "Sti.bios.rov.SEM;SEM_Obj"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.bios.rov.OBJ.OBJ_SEM_28_55']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.bios.rov.OBJ.OBJ_SEM_28_55']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.bios.rov.OBJ.OBJ_SEM_28_55'], fld); }");
        so.bind("$offsetof", fxn);
        ...
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.bios.rov.OBJ.OBJ_MBX_28_55", "ti.bios.rov");
        sizes.clear();
        sizes.add(Global.newArray("link", "Sti.bios.rov.QUE;QUE_Elem"));
        sizes.add(Global.newArray("type", "UInt"));
        sizes.add(Global.newArray("pad", "UInt"));
        sizes.add(Global.newArray("obj", "Sti.bios.rov.MBX;MBX_Obj"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.bios.rov.OBJ.OBJ_MBX_28_55']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.bios.rov.OBJ.OBJ_MBX_28_55']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.bios.rov.OBJ.OBJ_MBX_28_55'], fld); }");
        so.bind("$offsetof", fxn);
    }
    ...
    void LOG$$SIZES()
    {
        ...
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.bios.rov.LOG.LOG_Event_28_55L", "ti.bios.rov");
        sizes.clear();
        sizes.add(Global.newArray("pad", "UInt"));
        sizes.add(Global.newArray("seqnum", "UInt"));
        sizes.add(Global.newArray("val1", "TIArg"));
        ...
        sizes.add(Global.newArray("val3", "TIArg"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.bios.rov.LOG.LOG_Event_28_55L']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.bios.rov.LOG.LOG_Event_28_55L']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.bios.rov.LOG.LOG_Event_28_55L'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.bios.rov.LOG.LOG_Event_55", "ti.bios.rov");
        sizes.clear();
        sizes.add(Global.newArray("seqnum", "UInt"));
        sizes.add(Global.newArray("val1", "UPtr"));
        sizes.add(Global.newArray("val2", "UPtr"));
        sizes.add(Global.newArray("val3", "UPtr"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.bios.rov.LOG.LOG_Event_55']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.bios.rov.LOG.LOG_Event_55']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.bios.rov.LOG.LOG_Event_55'], fld); }");
        so.bind("$offsetof", fxn);
    ...
    void MEM$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
        // struct MEM.MEM_Segment6x55
        po = (Proto.Obj)om.findStrict("ti.bios.rov.MEM$$MEM_Segment6x55", "ti.bios.rov");
        po.init("ti.bios.rov.MEM.MEM_Segment6x55", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
        ...
        // struct MEM.MEM_Segment28x55L
        po = (Proto.Obj)om.findStrict("ti.bios.rov.MEM$$MEM_Segment28x55L", "ti.bios.rov");
        po.init("ti.bios.rov.MEM.MEM_Segment28x55L", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("base", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("len", Proto.Elm.newCNum("(xdc_ULong)"), $$UNDEF, "w");
                po.addFld("space", Proto.Elm.newCNum("(xdc_Int)"), $$UNDEF, "w");
        // struct MEM.MEM_Header6x55
        po = (Proto.Obj)om.findStrict("ti.bios.rov.MEM$$MEM_Header6x55", "ti.bios.rov");
        po.init("ti.bios.rov.MEM.MEM_Header6x55", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("next", new Proto.Adr("ti_bios_rov_MEM_MEM_Header6x55*", "PS"), $$UNDEF, "w");
                po.addFld("size", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
        // struct MEM.MEM_Header28x55L
        po = (Proto.Obj)om.findStrict("ti.bios.rov.MEM$$MEM_Header28x55L", "ti.bios.rov");
        po.init("ti.bios.rov.MEM.MEM_Header28x55L", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("next", new Proto.Adr("ti_bios_rov_MEM_MEM_Header28x55L*", "PS"), $$UNDEF, "w");
    ...
    void SWI$$TYPES()
    {
        ...
        // struct SWI.SWI_Obj_55
        po = (Proto.Obj)om.findStrict("ti.bios.rov.SWI$$SWI_Obj_55", "ti.bios.rov");
        po.init("ti.bios.rov.SWI.SWI_Obj_55", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("lock", Proto.Elm.newCNum("(xdc_Int)"), $$UNDEF, "w");
                po.addFld("ready", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("mask", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
                ...
                po.addFld("mailbox", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
                po.addFld("fxn", new Proto.Adr("xdc_Fxn", "Pf"), $$UNDEF, "w");
                po.addFld("arg1", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("arg0", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("stslock", Proto.Elm.newCNum("(xdc_Int)"), $$UNDEF, "w");
                po.addFld("sts", new Proto.Adr("xdc_Ptr*", "PPv"), $$UNDEF, "w");
    ...
    void ROV$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                ...
                po.addFxn("getTargetName", (Proto.Fxn)om.findStrict("ti.bios.rov.ROV$$getTargetName", "ti.bios.rov"), Global.get(cap, "getTargetName"));
    ...
    void OBJ$$TYPES()
    {
        ...
        // struct OBJ.OBJ_TSK_6x
        po = (Proto.Obj)om.findStrict("ti.bios.rov.OBJ$$OBJ_TSK_6x", "ti.bios.rov");
        po.init("ti.bios.rov.OBJ.OBJ_TSK_6x", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
        ...
        // struct OBJ.OBJ_TSK_28x
        po = (Proto.Obj)om.findStrict("ti.bios.rov.OBJ$$OBJ_TSK_28x", "ti.bios.rov");
        po.init("ti.bios.rov.OBJ.OBJ_TSK_28x", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("link", (Proto)om.findStrict("ti.bios.rov.QUE.QUE_Elem", "ti.bios.rov"), $$DEFAULT, "w");
                po.addFld("type", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
        ...
        // struct OBJ.OBJ_SEM_28_55
        po = (Proto.Obj)om.findStrict("ti.bios.rov.OBJ$$OBJ_SEM_28_55", "ti.bios.rov");
        po.init("ti.bios.rov.OBJ.OBJ_SEM_28_55", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("link", (Proto)om.findStrict("ti.bios.rov.QUE.QUE_Elem", "ti.bios.rov"), $$DEFAULT, "w");
                po.addFld("type", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
                po.addFld("pad", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
        ...
        // struct OBJ.OBJ_MBX_28_55
        po = (Proto.Obj)om.findStrict("ti.bios.rov.OBJ$$OBJ_MBX_28_55", "ti.bios.rov");
        po.init("ti.bios.rov.OBJ.OBJ_MBX_28_55", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("link", (Proto)om.findStrict("ti.bios.rov.QUE.QUE_Elem", "ti.bios.rov"), $$DEFAULT, "w");
                po.addFld("type", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
                po.addFld("pad", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
    ...
    void LOG$$TYPES()
    {
        ...
        // struct LOG.LOG_Event_28_55L
        po = (Proto.Obj)om.findStrict("ti.bios.rov.LOG$$LOG_Event_28_55L", "ti.bios.rov");
        po.init("ti.bios.rov.LOG.LOG_Event_28_55L", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("pad", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
                po.addFld("seqnum", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
                po.addFld("val1", new Proto.Adr("xdc_IArg", "Pv"), $$UNDEF, "w");
                po.addFld("val2", new Proto.Adr("xdc_IArg", "Pv"), $$UNDEF, "w");
                po.addFld("val3", new Proto.Adr("xdc_IArg", "Pv"), $$UNDEF, "w");
        // struct LOG.LOG_Event_55
        po = (Proto.Obj)om.findStrict("ti.bios.rov.LOG$$LOG_Event_55", "ti.bios.rov");
        po.init("ti.bios.rov.LOG.LOG_Event_55", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("seqnum", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
                po.addFld("val1", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("val2", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("val3", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
        // struct LOG.LOG_Obj
    ...
    void MEM$$ROV()
    {
        ...
        vo.bind("MEM_Segment6x55$fetchDesc", Global.newObject("type", "ti.bios.rov.MEM.MEM_Segment6x55", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.MEM$$MEM_Segment6x55", "ti.bios.rov");
        vo.bind("MEM_Segment28x55L$fetchDesc", Global.newObject("type", "ti.bios.rov.MEM.MEM_Segment28x55L", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.MEM$$MEM_Segment28x55L", "ti.bios.rov");
        vo.bind("MEM_Header6x55$fetchDesc", Global.newObject("type", "ti.bios.rov.MEM.MEM_Header6x55", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.MEM$$MEM_Header6x55", "ti.bios.rov");
        po.bind("next$fetchDesc", Global.newObject("type", "ti.bios.rov.MEM.MEM_Header6x55", "isScalar", false));
        vo.bind("MEM_Header28x55L$fetchDesc", Global.newObject("type", "ti.bios.rov.MEM.MEM_Header28x55L", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.MEM$$MEM_Header28x55L", "ti.bios.rov");
        po.bind("next$fetchDesc", Global.newObject("type", "ti.bios.rov.MEM.MEM_Header28x55L", "isScalar", false));
    }
    ...
    void SWI$$ROV()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.bios.rov.SWI$$SWI_Obj", "ti.bios.rov");
        vo.bind("SWI_Obj_55$fetchDesc", Global.newObject("type", "ti.bios.rov.SWI.SWI_Obj_55", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.SWI$$SWI_Obj_55", "ti.bios.rov");
    }
    ...
    void OBJ$$ROV()
    {
        ...
        vo.bind("OBJ_TSK_6x$fetchDesc", Global.newObject("type", "ti.bios.rov.OBJ.OBJ_TSK_6x", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.OBJ$$OBJ_TSK_6x", "ti.bios.rov");
        vo.bind("OBJ_TSK_28x$fetchDesc", Global.newObject("type", "ti.bios.rov.OBJ.OBJ_TSK_28x", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.OBJ$$OBJ_TSK_28x", "ti.bios.rov");
        ...
        po = (Proto.Obj)om.findStrict("ti.bios.rov.OBJ$$OBJ_SEM", "ti.bios.rov");
        vo.bind("OBJ_SEM_28_55$fetchDesc", Global.newObject("type", "ti.bios.rov.OBJ.OBJ_SEM_28_55", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.OBJ$$OBJ_SEM_28_55", "ti.bios.rov");
        vo.bind("OBJ_MBX$fetchDesc", Global.newObject("type", "ti.bios.rov.OBJ.OBJ_MBX", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.OBJ$$OBJ_MBX", "ti.bios.rov");
        vo.bind("OBJ_MBX_28_55$fetchDesc", Global.newObject("type", "ti.bios.rov.OBJ.OBJ_MBX_28_55", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.OBJ$$OBJ_MBX_28_55", "ti.bios.rov");
    }
    ...
    void LOG$$ROV()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.bios.rov.LOG$$LOG_Event_6x", "ti.bios.rov");
        vo.bind("LOG_Event_28_55L$fetchDesc", Global.newObject("type", "ti.bios.rov.LOG.LOG_Event_28_55L", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.LOG$$LOG_Event_28_55L", "ti.bios.rov");
        vo.bind("LOG_Event_55$fetchDesc", Global.newObject("type", "ti.bios.rov.LOG.LOG_Event_55", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.bios.rov.LOG$$LOG_Event_55", "ti.bios.rov");
    ...
    void MEM$$SINGLETONS()
    {
        ...
        mcfgs.add("Object__sizeof");
        mcfgs.add("Object__table");
        vo.bind("MEM_Segment6x55", om.findStrict("ti.bios.rov.MEM.MEM_Segment6x55", "ti.bios.rov"));
        tdefs.add(om.findStrict("ti.bios.rov.MEM.MEM_Segment6x55", "ti.bios.rov"));
        vo.bind("MEM_Segment28x55L", om.findStrict("ti.bios.rov.MEM.MEM_Segment28x55L", "ti.bios.rov"));
        tdefs.add(om.findStrict("ti.bios.rov.MEM.MEM_Segment28x55L", "ti.bios.rov"));
        vo.bind("MEM_Header6x55", om.findStrict("ti.bios.rov.MEM.MEM_Header6x55", "ti.bios.rov"));
        tdefs.add(om.findStrict("ti.bios.rov.MEM.MEM_Header6x55", "ti.bios.rov"));
        vo.bind("MEM_Header28x55L", om.findStrict("ti.bios.rov.MEM.MEM_Header28x55L", "ti.bios.rov"));
        tdefs.add(om.findStrict("ti.bios.rov.MEM.MEM_Header28x55L", "ti.bios.rov"));
    ...
    void SWI$$SINGLETONS()
    {
        ...
        vo.bind("SWI_Obj_55", om.findStrict("ti.bios.rov.SWI.SWI_Obj_55", "ti.bios.rov"));
        tdefs.add(om.findStrict("ti.bios.rov.SWI.SWI_Obj_55", "ti.bios.rov"));
    ...
    void OBJ$$SINGLETONS()
    {
        ...
        mcfgs.add("Object__sizeof");
        mcfgs.add("Object__table");
        vo.bind("OBJ_TSK_6x", om.findStrict("ti.bios.rov.OBJ.OBJ_TSK_6x", "ti.bios.rov"));
        tdefs.add(om.findStrict("ti.bios.rov.OBJ.OBJ_TSK_6x", "ti.bios.rov"));
        vo.bind("OBJ_TSK_28x", om.findStrict("ti.bios.rov.OBJ.OBJ_TSK_28x", "ti.bios.rov"));
        tdefs.add(om.findStrict("ti.bios.rov.OBJ.OBJ_TSK_28x", "ti.bios.rov"));
        ...
        vo.bind("OBJ_SEM_28_55", om.findStrict("ti.bios.rov.OBJ.OBJ_SEM_28_55", "ti.bios.rov"));
        tdefs.add(om.findStrict("ti.bios.rov.OBJ.OBJ_SEM_28_55", "ti.bios.rov"));
        ...
        vo.bind("OBJ_MBX_28_55", om.findStrict("ti.bios.rov.OBJ.OBJ_MBX_28_55", "ti.bios.rov"));
        tdefs.add(om.findStrict("ti.bios.rov.OBJ.OBJ_MBX_28_55", "ti.bios.rov"));
    ...
    void LOG$$SINGLETONS()
    {
        ...
        vo.bind("LOG_Event_28_55L", om.findStrict("ti.bios.rov.LOG.LOG_Event_28_55L", "ti.bios.rov"));
        tdefs.add(om.findStrict("ti.bios.rov.LOG.LOG_Event_28_55L", "ti.bios.rov"));
        vo.bind("LOG_Event_55", om.findStrict("ti.bios.rov.LOG.LOG_Event_55", "ti.bios.rov"));
        tdefs.add(om.findStrict("ti.bios.rov.LOG.LOG_Event_55", "ti.bios.rov"));
