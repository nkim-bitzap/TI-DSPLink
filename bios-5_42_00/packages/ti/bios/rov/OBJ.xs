...
function getTasks()
{
    ...
    if (ROV.getISA() == '28') {
        return (getObjects(OBJ.TSK, OBJ.OBJ_TSK_28x$fetchDesc));
    }
    else if (ROV.getISA() == '55') {
        return (getObjects(OBJ.TSK, OBJ.OBJ_TSK_55x$fetchDesc));    
    }
    else {
        return (getObjects(OBJ.TSK, OBJ.OBJ_TSK_6x$fetchDesc));
    }
}
...
function getSems()
{
    ...
    if ((ROV.getISA() == '28') || (ROV.getISA() == '55')) {
        return (getObjects(OBJ.SEM, OBJ.OBJ_SEM_28_55$fetchDesc));
    }
    else {
...
function getMailboxes()
{
    ...
    if ((ROV.getISA() == '28') || (ROV.getISA() == '55')) {
        return (getObjects(OBJ.MBX, OBJ.OBJ_MBX_28_55$fetchDesc));
    }
    else {
