...
module Types {
     ...
     *  diagnostics mask. 
     *
     *  @field(diags_ENTRY) The `{@link Diags#ENTRY}` bit of a module's
     *  diagnostics mask.
     *
     *  @field(diags_EXIT) The `{@link Diags#EXIT}` bit of a module's
     *  diagnostics mask.
     *
     *  @field(diags_INTERNAL) The `{@link Diags#INTERNAL}` bit of a module's
     *  diagnostics mask.
     *
     *  @field(diags_LIFECYCLE) The `{@link Diags#LIFECYCLE}` bit of a module's
     *  diagnostics mask. 
     *
     *  @field(diags_USER1) The `{@link Diags#USER1}` bit of a module's
     *  diagnostics mask.
     *
     *  @field(diags_USER2) The `{@link Diags#USER2}` bit of a module's
     *  diagnostics mask. 
     *
     *  @field(diags_USER3) The `{@link Diags#USER3}` bit of a module's
     *  diagnostics mask. 
     *
     *  @field(diags_USER4) The `{@link Diags#USER4}` bit of a module's
     *  diagnostics mask. 
     *
     *  @field(diags_USER5) The `{@link Diags#USER5}` bit of a module's
     *  diagnostics mask. 
     *
     *  @field(diags_USER6) The `{@link Diags#USER6}` bit of a module's
     *  diagnostics mask. 
     *
     *  @field(diags_USER7) The `{@link Diags#USER7}` bit of a module's
     *  diagnostics mask. 
     *
     *  @field(diags_USER8) The `{@link Diags#USER8}` bit of a module's
     *  diagnostics mask. 
     *
     *  @field(fxntab)
...
internal:
    ...
    typedef Void (*LoggerFxn4)(Ptr, EventId, IArg, IArg, IArg, IArg);
    typedef Void (*LoggerFxn8)(Ptr, EventId, IArg, IArg, IArg, IArg,
                                             IArg, IArg, IArg, IArg);
