 ...
 *! Revision History
 *! ================
 *! 27-Feb-2008 sasha	added xdoc for first() and next()
 *! 09-Jan-2008 sasha	added first() and next() functions to get to instances
...
interface IModule {
    ...
    metaonly readonly config Types.ViewInfo configNameMap$[string] = [
        ...
        ["xdc.runtime/Diagnostics", {viewType: "module", fields: [
            ...
            "common$.diags_LIFECYCLE", "common$.diags_USER1",
            "common$.diags_USER2", "common$.diags_USER3",
            "common$.diags_USER4", "common$.diags_USER5",
            "common$.diags_USER6", "common$.diags_USER7",
            "common$.diags_USER8"
        ]}],
