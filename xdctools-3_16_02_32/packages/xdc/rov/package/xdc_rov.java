...
public class xdc_rov
{
    ...
    void Model$$FUNCTIONS()
    {
        ...
        fxn = (Proto.Fxn)om.bind("xdc.rov.Model$$start", new Proto.Fxn(om.findStrict("xdc.rov.Model.Module", "xdc.rov"), null, 6, 6, false));
                fxn.addArg(0, "xmlVers", Proto.Elm.newCNum("(xdc_Int)"), $$UNDEF);
    ...
    void StateReader$$FUNCTIONS()
    {
        ...
        fxn = (Proto.Fxn)om.bind("xdc.rov.StateReader$$fetchInstState", new Proto.Fxn(om.findStrict("xdc.rov.StateReader.Instance", "xdc.rov"), (Proto)om.findStrict("xdc.rov.Program.ROVInstanceDesc", "xdc.rov"), 3, 3, false));
                fxn.addArg(0, "mod", new Proto.Adr("xdc_rov_Program_ROVModuleDesc*", "PS"), $$UNDEF);
        ...
        fxn = (Proto.Fxn)om.bind("xdc.rov.StateReader$$fetchHandleState", new Proto.Fxn(om.findStrict("xdc.rov.StateReader.Instance", "xdc.rov"), (Proto)om.findStrict("xdc.rov.Program.ROVInstanceDesc", "xdc.rov"), 2, 2, false));
                fxn.addArg(0, "mod", new Proto.Adr("xdc_rov_Program_ROVModuleDesc*", "PS"), $$UNDEF);
                fxn.addArg(1, "instAddr", Proto.Elm.newCNum("(xdc_Long)"), $$UNDEF);
        // fxn StateReader.getInstDesc
        fxn = (Proto.Fxn)om.bind("xdc.rov.StateReader$$getInstDesc", new Proto.Fxn(om.findStrict("xdc.rov.StateReader.Instance", "xdc.rov"), (Proto)om.findStrict("xdc.rov.Program.ROVInstanceDesc", "xdc.rov"), 3, 3, false));
                fxn.addArg(0, "mod", new Proto.Adr("xdc_rov_Program_ROVModuleDesc*", "PS"), $$UNDEF);
                fxn.addArg(1, "obj", $$T_Obj, $$UNDEF);
                fxn.addArg(2, "staticIndex", Proto.Elm.newCNum("(xdc_Int)"), $$UNDEF);
    }
    ...
    void Model$$TYPES()
    {
        ...
        po.init("xdc.rov.Model.Module", $$Module);
                ...
                po.addFld("xmlVers", Proto.Elm.newCNum("(xdc_Int)"), 3L, "wh");
